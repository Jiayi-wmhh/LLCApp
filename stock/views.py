...
def result(request):
   ...
   # Google search part
    ...
    plt.axis("off")
    plt.savefig("./LLCApp/LLCApp/static/top_search")

    rising_list = []
    for i in range(related_queries[ticker]["rising"].shape[0]):
        rising_list.append(related_queries[ticker]["rising"].loc[i,"query"])
    ...
    plt.imshow(word_cloud, interpolation='bilinear')
    plt.axis("off")
    plt.savefig("./LLCApp/LLCApp/static/rising_search")

    related_topic = pytrend.related_topics()
    rising_topic_list = []
    for i in range(related_topic[ticker]["rising"].shape[0]):
        rising_topic_list.append(related_topic[ticker]["rising"].loc[i,"topic_title"])
    ...
    plt.imshow(word_cloud, interpolation='bilinear')
    plt.axis("off")
    plt.savefig("./LLCApp/LLCApp/static/related_topic_search")
